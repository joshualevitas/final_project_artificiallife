...
class UNPICKLED_SOLUTION():
    def __init__(self, nextAvailableID,seed = None) -> None:
        ...
        self.Create_World()
        self.idNum = seed.idNum 
        self.links = seed.links
        self.joints = seed.joints
        self.numSensorsNeurons = seed.numSensorsNeurons 
        self.numMotorNeurons = seed.numMotorNeurons
        self.pieces = seed.pieces
        self.unclaimedJoints = seed.unclaimedJoints
        self.lastlinks = seed.lastlinks
